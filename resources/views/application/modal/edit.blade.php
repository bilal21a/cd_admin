...
<div class="fv-row mb-5 fv-plugins-icon-container">
    <label class="required fw-bold fs-6 mb-2">Joining Date</label>
    <input type="date" name="applicant_joining_date" class="form-control form-control-solid mb-3 mb-lg-0"
        value="{{ $user->applicant_joining_date }}">
    <div class="fv-plugins-message-container invalid-feedback"></div>
    @error('applicant_joining_date')
        <span class="text-danger">{{ $message }}</span>
    @enderror
</div>
